...
240 ifa=6thengraphic6:gshape,0,0,0,639,200:copy"hardcopy",d4:graphic7:print"{clr}{lt green}":goto160
250 ifa=7thengraphic6:gshape,0,0,0,639,200:char4,584,192,"{crsr down}return",0,0,14,53248:getkeya$:graphic7:goto150
260 :
...
1130 :
1140 scnclr:print"{clr}attendere."
...
1700 print"{crsr down}{crsr right}1 reticolato":print:print" 2 quadrati"
1710 poke208,0:getkeya$:ifval(a$)<1orval(a$)>2then1710:elsew=val(a$)
1720 graphic8:graphic6:color7,3
1730 :
