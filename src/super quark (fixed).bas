...
230 ifa=3thenscnclr:char,34,1,"attendere":goto20
240 ifa=6thengraphic6:gshape,0,0,0,639,200:copy"hardcopy",d4:graphic7:print"{clr}":goto160
...
1390 scnclr:char,0,1,"immetti coordinata a1":char,0,3,"a1=":char,0,20,"attuale valore:":printd1
1400 d1$="":x=3:ln=len(d1$):gosub440:d1$=xx$:ifsp=0then1410:elsed1=val(d1$)
1410 scnclr:char,0,1,"immetti coordinata a2":char,0,3,"a2=":char,0,20,"attuale valore:":printd2
1420 d2$="":x=3:ln=len(d2$):gosub440:d2$=xx$:ifsp=0then1430:elsed2=val(d2$)
1430 scnclr:char,0,1,"immetti coordinata a3":char,0,3,"a3=":char,0,20,"attuale valore:":printd3
...
1490 printchr$(7):char,34,1,"attendere":kk=r/sqr(d1^2+d2^2+d3^2)
...
2220 data169,0,141,0,255,169,124,133,252,169,0,133,251,162,18,168
2230 data32,65,22,32,216,205,162,63,142,0,255,145,251,165,252,201
2240 data188,240,14,162,0,142,0,255,230,251,208,2,230,252,76,19
2250 data11,96,169,0,141,0,255,169,60,133,252,169,0,133,251,162
2260 data18,168,32,65,22,169,63,141,0,255,177,251,162,0,142,0
2270 data255,32,202,205,230,251,208,2,230,252,165,252,201,124,240,3
2280 data76,69,11,96
